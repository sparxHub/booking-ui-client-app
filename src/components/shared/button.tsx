...
> = {
  default: {
    bold: "bg-primary-900 text-primary-100 shadow-md hover:bg-primary-700 focus-visible:ring-primary-500",
    light:
      "bg-primary-100 text-primary-700 hover:bg-primary-200 focus-visible:ring-primary-500",
    outline:
      "border border-primary-900 text-primary-900 hover:bg-primary-400 focus-visible:ring-primary-800",
