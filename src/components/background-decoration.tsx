  ...
  return (
    ...
    >
      ...
      <div className="relative col-span-2 hidden overflow-hidden bg-primary-600 xl:block">
        <div className="absolute -bottom-40 -left-40 hidden aspect-square w-[700px] animate-subtle rounded-full border-[110px] border-primary-400 xl:block"></div>
      </div>
      {/* Right split */}
      <div className="relative col-span-2 hidden overflow-hidden bg-primary-500 xl:block">
        <div className="absolute -left-32 -top-32 aspect-square w-[700px] animate-subtle rounded-full border-[110px] border-primary-400"></div>
